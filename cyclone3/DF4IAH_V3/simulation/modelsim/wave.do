...
add wave -noupdate -expand -group Amber_Execute -group Internal -group Address -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/alu_plus4
add wave -noupdate -expand -group Amber_Execute -group Internal -group Address -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/rn_plus4
add wave -noupdate -expand -group Amber_Execute -group Internal -group Address -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/alu_out
add wave -noupdate -expand -group Amber_Execute -group Internal -group Address -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/alu_flags
add wave -noupdate -expand -group Amber_Execute -group Internal -group Address -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/rm
add wave -noupdate -expand -group Amber_Execute -group Internal -group Address -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/rs
add wave -noupdate -expand -group Amber_Execute -group Internal -group Address -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/rd
add wave -noupdate -expand -group Amber_Execute -group Internal -group Address -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/rn
add wave -noupdate -expand -group Amber_Execute -group Internal -group Address -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/pc
add wave -noupdate -expand -group Amber_Execute -group Internal -group Address -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/pc_nxt
add wave -noupdate -expand -group Amber_Execute -group Internal -group Address -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/interrupt_vector
add wave -noupdate -expand -group Amber_Execute -group Internal -group Address -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/base_address
add wave -noupdate -expand -group Amber_Execute -group Internal -group Address -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/address_update
add wave -noupdate -expand -group Amber_Execute -group Internal -group Address -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/base_address_update
add wave -noupdate -expand -group Amber_Execute -group Internal -group Address -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/address_r
add wave -noupdate -expand -group Amber_Execute -group Internal -group Address -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/save_int_pc
add wave -noupdate -expand -group Amber_Execute -group Internal -group Address -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/save_int_pc_m4
add wave -noupdate -expand -group Amber_Execute -group Internal -group Address -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/reg_write_nxt
add wave -noupdate -expand -group Amber_Execute -group Internal -group Address -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/pc_wen
add wave -noupdate -expand -group Amber_Execute -group Internal -group Address -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/priviledged_nxt
add wave -noupdate -expand -group Amber_Execute -group Internal -group Address -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/write_data_nxt
add wave -noupdate -expand -group Amber_Execute -group Internal -group Address -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/write_enable_nxt
add wave -noupdate -expand -group Amber_Execute -group Internal -group Address -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/byte_enable_nxt
add wave -noupdate -expand -group Amber_Execute -group Internal -group Address -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/adex_nxt
add wave -noupdate -expand -group Amber_Execute -group Internal -group ALU -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/reg_bank_wen
add wave -noupdate -expand -group Amber_Execute -group Internal -group ALU -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/reg_bank_wsel
add wave -noupdate -expand -group Amber_Execute -group Internal -group ALU -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/multiply_out
add wave -noupdate -expand -group Amber_Execute -group Internal -group ALU -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/multiply_flags
add wave -noupdate -expand -group Amber_Execute -group Internal -group ALU -group Barrel -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/shift_amount
add wave -noupdate -expand -group Amber_Execute -group Internal -group ALU -group Barrel -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/barrel_shift_in
add wave -noupdate -expand -group Amber_Execute -group Internal -group ALU -group Barrel -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/barrel_shift_out
add wave -noupdate -expand -group Amber_Execute -group Internal -group ALU -group Barrel -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/barrel_shift_carry
add wave -noupdate -expand -group Amber_Execute -group Internal -group ALU -group Barrel -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/barrel_shift_carry_alu
add wave -noupdate -expand -group Amber_Execute -group Internal -group ALU -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/alu_out_pc_filtered
add wave -noupdate -expand -group Amber_Execute -group Internal -group ALU -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/carry_in
add wave -noupdate -expand -group Amber_Execute -group Internal -group ALU -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/execute
add wave -noupdate -expand -group Amber_Execute -group Internal -group Update_REGs -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/priviledged_update
add wave -noupdate -expand -group Amber_Execute -group Internal -group Update_REGs -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/write_data_update
add wave -noupdate -expand -group Amber_Execute -group Internal -group Update_REGs -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/copro_write_data_update
add wave -noupdate -expand -group Amber_Execute -group Internal -group Update_REGs -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/byte_enable_update
add wave -noupdate -expand -group Amber_Execute -group Internal -group Update_REGs -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/data_access_update
add wave -noupdate -expand -group Amber_Execute -group Internal -group Update_REGs -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/write_enable_update
add wave -noupdate -expand -group Amber_Execute -group Internal -group Update_REGs -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/exclusive_update
add wave -noupdate -expand -group Amber_Execute -group Internal -group Status -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/status_bits_flags_nxt
add wave -noupdate -expand -group Amber_Execute -group Internal -group Status -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/status_bits_flags
add wave -noupdate -expand -group Amber_Execute -group Internal -group Status -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/status_bits_mode_nxt
add wave -noupdate -expand -group Amber_Execute -group Internal -group Status -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/status_bits_mode_nr
add wave -noupdate -expand -group Amber_Execute -group Internal -group Status -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/status_bits_mode
add wave -noupdate -expand -group Amber_Execute -group Internal -group Status -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/status_bits_mode_rds_nxt
add wave -noupdate -expand -group Amber_Execute -group Internal -group Status -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/status_bits_mode_rds_nr
add wave -noupdate -expand -group Amber_Execute -group Internal -group Status -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/status_bits_mode_rds
add wave -noupdate -expand -group Amber_Execute -group Internal -group Status -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/status_bits_mode_rds_oh_nxt
add wave -noupdate -expand -group Amber_Execute -group Internal -group Status -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/status_bits_mode_rds_oh
add wave -noupdate -expand -group Amber_Execute -group Internal -group Status -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/status_bits_mode_rds_oh_update
add wave -noupdate -expand -group Amber_Execute -group Internal -group Status -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/status_bits_irq_mask_nxt
add wave -noupdate -expand -group Amber_Execute -group Internal -group Status -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/status_bits_irq_mask
add wave -noupdate -expand -group Amber_Execute -group Internal -group Status -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/status_bits_firq_mask_nxt
add wave -noupdate -expand -group Amber_Execute -group Internal -group Status -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/status_bits_firq_mask
add wave -noupdate -expand -group Amber_Execute -group Internal -group Status -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/status_bits_flags_update
add wave -noupdate -expand -group Amber_Execute -group Internal -group Status -radix hexadecimal /tb_top/u_dut/u_system/u_amber/u_execute/status_bits_mode_update
...
WaveRestoreCursors {{Cursor 1} {11150133 ps} 0} {{Cursor 2} {11179113 ps} 0} {{Cursor 3} {8125000 ps} 0}
