...
quietly virtual signal -install /tb_top {/tb_top/o_monitor[36]  } MONITOR_ramsync2_sys_rst
...
add wave -noupdate -color Tan /tb_top/MONITOR_ramsync2_sys_rst
...
WaveRestoreCursors {{Cursor 1} {23810356 ps} 0} {{Cursor 2} {23942102 ps} 0}
...
update
WaveRestoreZoom {24353575 ps} {25031911 ps}
